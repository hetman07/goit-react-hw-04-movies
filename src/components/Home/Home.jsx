...
import {GridList, GridListTile, GridListTileBar, ListSubheader, IconButton, CircularProgress} from '@material-ui/core';
...
// console.log('render error', error);
        return (
          <div className={classes.root}>
            {error &&  (<div className={classes.rootAlert}>
        ...
        <GridList cellHeight={500} className={classes.gridList} cols={3}>
          <GridListTile key="Subheader" cols={3} style={{ height: 'auto' }}>
            ...
            <img src={`${routes.path}${movie.poster_path}`} alt={movie.title} />                  
            <Link 
                to={{
            ...
            <GridListTileBar
              title={movie.title}
              subtitle={<Rating name="half-rating" defaultValue={movie.vote_average} precision={0.5} max={10} size={'small'} readOnly/>}
              actionIcon={
